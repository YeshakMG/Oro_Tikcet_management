        ...
        child: Card(
          ...
          child: Obx(() => Column(
                ...
                children: [
                  ...
                  Text(controller.agencyName.value, style: const TextStyle(fontWeight: FontWeight.bold)),
                  ...
                  Padding(
                    ...
                    child: Table(
                      ...
                      children: [
                        _buildTableRow("Plate Number", controller.plateNumber.value),
                        _buildTableRow("Seat No.", controller.seatNo.value),
                        _buildTableRow("Date and Time", controller.dateTime.value),
                        _buildTableRow("KM", controller.km.value),
                        _buildTableRow("Tariff", controller.tariff.value),
                        _buildTableRow("Service Charge", controller.serviceCharge.value),
                      ],
                    ),
                  ),
                  const Divider(),
                  Text("TOTAL: ${controller.total.value}", style: const TextStyle(fontWeight: FontWeight.bold)),
                  ...
                  Container(
                    ...
                    child: const Text("||| ||| |||| || |||", style: TextStyle(fontSize: 24, letterSpacing: 4)),
                  ),
                  const SizedBox(height: 16),
                  Row(
